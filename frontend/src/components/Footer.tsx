        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-8 mb-16">
          ...
          <div className="md:col-span-5 lg:col-span-4 flex flex-col gap-6">
            ...
            <div className="flex items-center gap-4 pt-2">
              <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white border border-gray-100 shadow-sm flex items-center justify-center text-gray-400 hover:text-white hover:bg-indigo-600 hover:border-indigo-600 transition-all duration-300 transform hover:-translate-y-1">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path></svg>
              </a>
              <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white border border-gray-100 shadow-sm flex items-center justify-center text-gray-400 hover:text-white hover:bg-sky-500 hover:border-sky-500 transition-all duration-300 transform hover:-translate-y-1">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z"></path></svg>
              </a>
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white border border-gray-100 shadow-sm flex items-center justify-center text-gray-400 hover:text-white hover:bg-pink-600 hover:border-pink-600 transition-all duration-300 transform hover:-translate-y-1">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="20" x="2" y="2" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"></line></svg>
              </a>
              <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white border border-gray-100 shadow-sm flex items-center justify-center text-gray-400 hover:text-white hover:bg-blue-700 hover:border-blue-700 transition-all duration-300 transform hover:-translate-y-1">
          ...
          <div className="md:col-span-3 lg:col-span-2 lg:col-start-7">
            ...
            <ul className="space-y-4">
              <li>
                <Link to="/" onClick={() => window.scrollTo(0,0)} className="text-gray-500 hover:text-indigo-600 transition-all duration-300 flex items-center gap-2 group font-medium">
              ...
              <li>
                <Link to="/about" onClick={() => window.scrollTo(0,0)} className="text-gray-500 hover:text-indigo-600 transition-all duration-300 flex items-center gap-2 group font-medium">
                  <ChevronRight size={14} className="text-transparent group-hover:text-indigo-600 transform -translate-x-2 group-hover:translate-x-0 transition-all duration-300" />
                  <span className="transform -translate-x-4 group-hover:translate-x-0 transition-all duration-300">About us</span>
                </Link>
              </li>
              <li>
                <Link to="/contact" onClick={() => window.scrollTo(0,0)} className="text-gray-500 hover:text-indigo-600 transition-all duration-300 flex items-center gap-2 group font-medium">
                  <ChevronRight size={14} className="text-transparent group-hover:text-indigo-600 transform -translate-x-2 group-hover:translate-x-0 transition-all duration-300" />
                  <span className="transform -translate-x-4 group-hover:translate-x-0 transition-all duration-300">Contact us</span>
                </Link>
              </li>
              <li>
                <Link to="#" className="text-gray-500 hover:text-indigo-600 transition-all duration-300 flex items-center gap-2 group font-medium">
                  <ChevronRight size={14} className="text-transparent group-hover:text-indigo-600 transform -translate-x-2 group-hover:translate-x-0 transition-all duration-300" />
